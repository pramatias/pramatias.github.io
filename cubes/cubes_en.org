...
Rust's implementation isn't ideal, but I kept it that way to be as similar as possible to the other implementations. Also Rust doesn't have proper recursion (TCO is not always applied).
